...
checkSum32 =
    fromRight (error "Colud not decode bytes as CheckSum32") .
    decode . BS.take 4 . BA.convert . hashWith SHA256 . hashWith SHA256
...
split512 h = (Hash256 (BSS.toShort a), Hash256 (BSS.toShort b))
  where
